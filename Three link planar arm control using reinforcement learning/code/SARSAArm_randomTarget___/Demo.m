...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
global x1 y1 x2 y2 x3 y3                	% position variable
global pF1 pF2 pF3							% handles for fill
global C2 C3                            	% handles for the joint's circle
global J2 J3                            	% handles for the joint's pluses
...
B =[xb' yb' zeros(size(xb))' ones(size(xb))']'./2;  % Link3 matrix
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% Link1 and Link2  
...
xL1=[0 7.1875 7.1875 7.72978 xc 7.72978 7.1875 7.1875 0 xa 0]./2;
yL1=[1.125 1.125 .875 .68133 yc -.68133 -.875 -1.125 -1.125 ya 1.125]./2;
Link1=[xL1' yL1' zeros(size(xL1))' ones(size(xL1))']';  % Link1 matrix
Link2=Link1;				% Link1 and Link2 are the same
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% Link3  
xL3=[0 2.875 3.125 3.125 4.875 6.625 6.6258 4.875 3.125 3.125 2.875 0 xa ]./2;
yL3=[1.125*ones(1,3) .875 .875 .25 -.25 -.875 -.875 -1.125*ones(1,3) ya ]./2;
Link3=[xL3' yL3' zeros(size(xL3))' ones(size(xL3))']';  % Link3 matrix
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
l1=8.625/2;				% distance between frame '1' and '2'
l2=l1;					% distance between frame '2' and '3'
l3=6.125/2;				% distance between frame '3' and 'tool'
...
%legend('Workspace')
%Goal Position
goal = plot(0,0,'.r','markersize',35);

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
grid off						% turns on grid
set(gca,'XTick',[-10:5:10])	 % numbers on y-axis
...
plot(x1,y1,'ok', 'markersize', 5);					            % circle at joint '1'
C2=plot(x2,y2,'ok', 'erasemode','normal', 'markersize', 5);		% circle at joint '2'
C3=plot(x3,y3,'ok', 'erasemode','normal', 'markersize', 5);		% circle at joint '3'
% Ct=plot(xt,yt,'ok', 'erasemode','normal');		% circle at joint 'T'
plot(x1,y1,'.k', 'MarkerSize', 5);					            % plus at joint '1'
J2=plot(x2,y2,'.k', 'erasemode','normal', 'MarkerSize', 5);		% plus at joint '2'
J3=plot(x3,y3,'.k', 'erasemode','normal', 'MarkerSize', 5);		% plus at joint '3'
% Jt=plot(xt,yt,'.k', 'erasemode','normal', 'MarkerSize', 10);		% plus at joint 'T'
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
