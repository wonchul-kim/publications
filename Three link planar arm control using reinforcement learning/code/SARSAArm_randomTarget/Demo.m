...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% Link3  
xL3=[0 2.875 3.125 3.125 4.875 6.625 6.6258 4.875 3.125 3.125 2.875 0 xa ];
yL3=[1.125*ones(1,3) .875 .875 .25 -.25 -.875 -.875 -1.125*ones(1,3) ya ];
...
plot(x1,y1,'ok', 'markersize', 15);					            % circle at joint '1'
C2=plot(x2,y2,'ok', 'erasemode','normal', 'markersize', 15);		% circle at joint '2'
C3=plot(x3,y3,'ok', 'erasemode','normal', 'markersize', 15);		% circle at joint '3'
% Ct=plot(xt,yt,'ok', 'erasemode','normal');		% circle at joint 'T'
plot(x1,y1,'.k', 'MarkerSize', 10);					            % plus at joint '1'
J2=plot(x2,y2,'.k', 'erasemode','normal', 'MarkerSize', 10);		% plus at joint '2'
J3=plot(x3,y3,'.k', 'erasemode','normal', 'MarkerSize', 10);		% plus at joint '3'
