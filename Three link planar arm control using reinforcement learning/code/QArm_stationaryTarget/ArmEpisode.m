function [ total_reward,steps,Q1,Q2,Q3 ] = ArmEpisode( maxsteps, Q1, Q2, Q3 ,xf, yf , alpha, gamma,epsilon,statelist,actionlist)
...
global T1 T2 T3 TxtSteps grafica MOVIE
...
s2   = DiscretizeState([T1 T2 T3],statelist);
s3   = DiscretizeState([T1 T2 T3],statelist);
...
for i=1:maxsteps    
    ...
    sp2   = DiscretizeState([T1 T2 T3],statelist);
    sp3   = DiscretizeState([T1 T2 T3],statelist);
    ...
    Q1 = UpdateQ( s1, sp1, r, a1, Q1 , alpha, gamma );
    Q2 = UpdateQ( s2, sp2, r, a2, Q2 , alpha, gamma );
    Q3 = UpdateQ( s3, sp3, r, a3, Q3 , alpha, gamma );
