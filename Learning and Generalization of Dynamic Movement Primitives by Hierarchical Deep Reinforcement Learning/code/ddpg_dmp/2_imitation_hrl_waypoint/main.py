...
def parse_args():
    ...
    parser.add_argument('--imitation-lr', type=float, default=1e-4)
    ...
    parser.add_argument('--noise-type', type=str, default= 'adaptive-param_0.3')  # choices are adaptive-param_xx, ou_xx, normal_xx, none
