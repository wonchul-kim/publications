...
def train(env, nb_epochs, nb_epoch_cycles, render_eval, reward_scale, render, param_noise, actor, critic,
    ...
    tau=0.01, eval_env=None, param_noise_adaption_interval=50, display_on=False, eval_display_on=False):
        ...
        for epoch in range(nb_epochs):
            for cycle in range(nb_epoch_cycles):
                ...
                for t_rollout in range(nb_rollout_steps):
                    ...
                    t += 1
                    if rank == 0 and render and epoch > 3:
                        env.render()
                    episode_reward += r
                    episode_step += 1
                    ...
                    obs = new_obs
                    print('\r', t_rollout, cycle, epoch, episode_reward, end='')
